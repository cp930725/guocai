...
class Cash extends WebLoginBase{
	public $xhUrl = 'https://s.starfireotc.com/payLink/web.html';
	public $appKey = 'c1c91d7b25a24ca3951857fbf6f08611';
	public $md5Key = 'a8208742c42f0ef2701909e97a9400ee';
	public $pickupUrl = 'http://web.jdswzc.com/';
	public $receiveUrl = 'http://admin.jdswzc.com/index.php/business/rechargeHandle';
	public $signType = 'MD5';
	public $pageSize=20;
	 ...
	 * 星火支付接口
	 */
	public function getCurl($outOrderId, $customerAmountCny = null, $customerAmount = null)
	{
		$str = $outOrderId.$customerAmount.$this->pickupUrl.$this->receiveUrl.$customerAmountCny.$this->signType.$this->md5Key;
		$sign = md5($str);
		$url = $this->xhUrl.'?outOrderId='.$outOrderId.'&customerAmount='.$customerAmount.'&customerAmountCny='.$customerAmountCny.'&APPKey='.$this->appKey.'&pickupUrl='.$this->pickupUrl.'&receiveUrl='.$this->receiveUrl.'&signType'.$this->signType.'&sign='.$sign;
