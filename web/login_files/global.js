...
function _jcms_Dialog(styletype, title, width, height, iswhat, showCloseBox) {
    ...
    this.open = function (_sUrl, _returnFunc, _sMode) {
        ...
        $i("dialogBody").innerHTML = "<iframe id='dialogFrame' name='dialogFrame' src='" + site.Dir + "/statics/html/loading.html' width='" + oWidth + "' height='" + oHeight + "' frameborder='no' border='0' marginwidth='0' marginheight='0' scrolling='" + _sMode + "'></iframe>";
