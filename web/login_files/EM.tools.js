$(function () {
    //    $(".lottery-switch").delegate('a', 'click', function (event) {
    //        $(this).parents().find("a").removeClass("active");
    //        $(this).addClass("active");
    //        var nmb = $(this).attr("nmb");
    //        if (nmb == "0") {
    //            $("#lottery-page").removeClass("lottery-night");
    //        } else {
    //            $("#lottery-page").addClass("lottery-night");
    //        }
    //    });
});
