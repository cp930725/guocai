        ...
        <div class="bg clearfix">
        	<div id="siderbar">
                <ul class="list clearfix">
                   <li class="current"><a href="/index.php/cash/recharge2">扫码支付</a></li>
                    <!--<li class=""><a href="/index.php/cash/recharge" >在线充值</a></li>
					<!--<li class=""><a href="/index.php/cash/recharge3">微信备用充值</a></li>
					<li class=""><a href="/index.php/cash/recharge4">支付宝备用充值</a></li>-->
                </ul>
            </div>
...
<?php
			$set=$this->getSystemSettings();
				$sql="select * from {$this->prename}bank_list b, {$this->prename}sysadmin_bank m where m.admin=1 and m.enable=1 and b.isDelete=0 and b.id=m.bankId and b.id  in(32,34,35)";
        ...
        点击下一步根据提示完成支付，支付成功后一定要等待跳转到商家页面或等待自动跳转，显示充值订单成功后再关闭网页，如未自动到账请复制订单编号联系在线客服核查！
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable" xstyle="display:none">
              <tbody><tr>
                  <td><h3>请选择支付银行</h3></td>
              </tr>
              <tr>
				...
				<div id="2tips" data="0"></div>
		          <div align="center" xstyle="display:none">
    ...
    <?php }?>
      <?php }else{ ?>
        <div class="container" style=" width: auto">
			<div id="error">
				<h3 class="title">	
				<font color="#ff0000">对不起，未开通该银行的充值权限，请使用在线充值或其它银行进行充.请先对接支付后才能跳转到相应页面，否则找不到下一步的跳转页面。。</font>
				</h3>
			</div>
        </div>
     <?php }?>		
