...
<li class="current"><a href="/index.php/team/memberList" >会员列表</a></li>
...
<div id="contentBox">
    <form action="/index.php/team/searchMember" dataType="html" target="ajax" method="get" onajax="teamBeforeSearchMember" call="teamSearchMember">
        ...
        <div id="searchBox" class="re">
             ...
             <input type="text" class="input150" placeholder="用户名" name="username"/>  
          ...
          <input type="submit" value="查询" class="formCheck chazhao" /></div>
    </form>
    </div>
