<?php $this->display('inc_daohang_daili.php'); 
...
<li class="current"><a href="/index.php/team/coinall" >团队总览</a></li>	
...
<li ><a href="/index.php/team/onlineMember" >在线会员</a></li>	
...
<?php if($this->user['fanDian'] == '13.0' || $this->user['fanDian'] == '12.9'){?><li ><a href="/index.php/team/shareBonus" >团队分红</a></li><?php } ?>		
</ul>
</div>
