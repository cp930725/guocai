			...
			<div class="air_box_t">
				<div class="airflash" id="air_top">
    				...
    				<script type="text/javascript">
			            ...
			            so.addVariable("appurl", "#"); // 在这里修改AIR客户端下载地址，air名称Main可以随意修改
...
<div class="login_footer">
	<div class="warp980">
		<div class="img"></div>
		<div class="clearfix">
			<p class="t-left"><font color="#FFFFFF">
				浏览器建议：首选为Google浏览器，其次为火狐和IE9或IE10浏览器<br>分辨率建议：使用1024×768以上的分辨率</font>			</p>
			<p class="t-right">
				<font color="#FFFFFF">未满18周岁禁止购买<br>
				Copyright © SinCai 2010-2016  <?=$this->settings['webName']?> 版权所有		</font>	</p>
		</div>
	</div>
</div>
<script type='text/javascript'>
