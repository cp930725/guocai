...
function animate() {
	var random1 = Math.floor((Math.random() * 10) + 30);
	random1 = random1 / 10;

	var random2 = Math.floor((Math.random() * 10) + 30);
	random2 = random2 / 10;

	var random3 = Math.floor((Math.random() * 10) + 30);
	random3 = random3 / 10;

	var random4 = Math.floor((Math.random() * 10) + 30);
	random4 = random4 / 10;

	var random5 = Math.floor((Math.random() * 10) + 30);
	random5 = random5 / 10;

	var random6 = Math.floor((Math.random() * 10) + 30);
	random6 = random6 / 10;

	var random7 = Math.floor((Math.random() * 10) + 30);
	random7 = random7 / 10;

	var random8 = Math.floor((Math.random() * 10) + 30);
	random8 = random8 / 10;

	var random9 = Math.floor((Math.random() * 10) + 30);
	random9 = random9 / 10;

	var random10 = Math.floor((Math.random() * 10) + 30);
	...
	var random1b = Math.floor((Math.random() * 60) + 20);
	activateflame(random1b, "1");
	random1b = random1b + "px";

	var random2b = Math.floor((Math.random() * 360) + 20);
	activateflame(random2b, "2");
	random2b = random2b + "px";
     
	var random3b = Math.floor((Math.random() * 360) + 20);
	activateflame(random3b, "3");
	random3b = random3b + "px";

	var random4b = Math.floor((Math.random() * 360) + 20);
	activateflame(random4b, "4");
	random4b = random4b + "px";

	var random5b = Math.floor((Math.random() * 360) + 20);
	activateflame(random5b, "5");
	random5b = random5b + "px";

	var random6b = Math.floor((Math.random() * 360) + 20);
	activateflame(random6b, "6");
	random6b = random6b + "px";

	var random7b = Math.floor((Math.random() * 360) + 20);
	activateflame(random7b, "7");
	random7b = random7b + "px";

	var random8b = Math.floor((Math.random() * 360) + 20);
	activateflame(random8b, "8");
	random8b = random8b + "px";

	var random9b = Math.floor((Math.random() * 360) + 20);
	activateflame(random9b, "9");
	random9b = random9b + "px";

	var random10b = Math.floor((Math.random() * 360) + 20);
...
function checkposition() {
	...
	for(var i = 0; i < 10; i++) {
		...
		$(position).css('background-image','url(static/img/public/pk10/'+ (parseFloat(carssquencename) + 1) +'.png)');
	}
...
function countdowntimer(timer) {
	...
	if(timer == 2) {
		if(ifopen){
			$("#sound").attr("src", "static/mp3/cuttime.mp3");
		}
		document.getElementById("sound").pause();
		if(ifopen && videoTools.ifsund()) {
			document.getElementById("sound").play();
...
function startanimation() {
	setTimeout(function() {
		$("#sound").attr("src", "static/mp3/staring.mp3");
		document.getElementById("sound").pause();
		if(ifopen && videoTools.ifsund()) {
...
function finishgame(finalresult) {
	setTimeout(function() {
		if(ifopen){
			$("#sound").attr("src", "static/mp3/over.mp3");
		}
		document.getElementById("sound").pause();
		if(ifopen && videoTools.ifsund()) {
		...
		setTimeout(function(){
			$("#sound").attr("src", "static/mp3/bg.mp3");
		},8000);
	}, 3000);
	TweenLite.killDelayedCallsTo(winnerpage);
	$(".page1").css("display", "block");
	...
	for(var i = 0; i < 10; i++) {
		...
		var winningpos = (i * 50) - carpositionoffset[caroffset] + 110;
...
function showcurrentresult(results) {
	...
	for(var i = 0; i < 10; i++) {
		var posname = i + 1;
		var position = "#pos" + posname;
		var carssquencename = resultarry[i];
		$(position).css('background-image','url(static/img/public/pk10/'+ (parseFloat(carssquencename)) +'.png)');
	}
}
...
function winnerpage(results) {
	...
	$(".resultcar1").css("left", "50%");
	$(".resultcar1").css("top", "50%");
	$(".resultcar2").css("left", "20%");
	$(".resultcar2").css("top", "50%");
	$(".resultcar3").css("left", "80%");
	$(".resultcar3").css("top", "60%");
	...
	for(var i = 0; i < 3; i++) {
		...
		$(position).attr("src", "static/images/winner" + resultarry[i] + ".png");
	}
