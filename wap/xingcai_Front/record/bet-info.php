...
<div class="popupModal">
	<table cellpadding="0" cellspacing="0" width="100%" style="width: 100%;margin-top: 15px;" class="form-tips">
        ...
        <tr>
			...
			<td><em>期号：</em><span class="red"><?=$bet['actionNo']?></span></td>
		</tr>
		...
		<tr>
		<td colspan="4"><em>购买盈亏：￥</em><em class="green"><?=$this->iff($bet['lotteryNo'], number_format($bet['bonus'] - $betCont + ($bet['fanDian']/100)*$betCont, 3), '－')?></em> 元<em class="green">&nbsp(<?=$this->iff($bet['lotteryNo'], $this->iff(number_format($bet['bonus'] - $betCont + ($bet['fanDian']/100)*$betCont, 3)>=0,"赢","亏"), '－')?>)</em></td>
		</tr>
