...
<?php
$codeNum = $this->getValue("select codeNum from {$this->prename}played where id={$this->played}");
?>
<div maxlen="<?= $codeNum ?>" class="pp" action="tz11x5WeiInput" length="2" >
	<div id="wei-shu" length="2" style="width:100%">
        ...
        <div style=" line-height:200%;display:inline-block; width:15%" onclick="ckall()"></div>
	</div>
